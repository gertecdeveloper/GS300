...
{---------------------------------------------------------------------------
    IMPORTANTE: PARA FUNCIONAR O NFC É NECESSÁRIO HABILITAR A OPÇÃO NFC
    NAS CONFIGURAÇÕES DAS PERMISSÕES DO USUÁRIO. O GS300 TAMBÉM PRECISA TER
    A OPÇÃO NFC HABILITADA NAS CONFIGURAÇÕES DO EQUIPAMENTO
---------------------------------------------------------------------------}
