...
public class Teste extends AppCompatActivity {
    ...
    private Button button_consultar, button_status, button_teste, button_vendas,
            button_cancelamento, button_sessao;
        ...
        button_status.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                if (txtCodAtivacao.getText().toString().length() >= 8) {
                    ...
                    Toast.makeText(Teste.this, "Código de Ativação deve ter entre 8 a 32 " +
                            "caracteres!", Toast.LENGTH_LONG).show();
                }
            }
        });
                ...
                builder.setNeutralButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                if (input.getText().toString().length() > 0) {
                                    ...
                                    Toast.makeText(Teste.this, "Digite uma chave de " +
                                            "cancelamento!", Toast.LENGTH_LONG).show();
                                }
                            }
                        }
                );
                ...
                builder.setNeutralButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        if (input.getText().toString().length() > 0) {
                            ...
                            Toast.makeText(Teste.this, "Digite um número de sessão!",
    ...
    public void repostaSat(String operacao) {
        ...
        switch (operacao) {
            ...
            case "ConsultarStatusOperacional":
                retornoOperaca = satFunctions.consultarStatusOperacional(gerador.nextInt(999999),
                        txtCodAtivacao.getText().toString());
                break;
            case "EnviarTesteFim":
                retornoOperaca = satFunctions.enviarTesteFim(txtCodAtivacao.getText().toString(),
            ...
            case "EnviarTesteVendas":
                ...
                // retornoOperaca = satFunctions.enviarTesteVendas(txtCodAtivacao.getText()
                // .toString(), gerador.nextInt(999999));
                break;
            case "CancelarUltimaVenda":
                retornoOperaca =
                        satFunctions.cancelarUltimaVenda(txtCodAtivacao.getText().toString(),
                                inputText, gerador.nextInt(999999));
                break;
            case "ConsultarNumeroSessao":
                retornoOperaca =
                        satFunctions.consultarNumeroSessao(txtCodAtivacao.getText().toString(),
                                Integer.valueOf(inputText.trim()), gerador.nextInt(999999));
                break;
            default:
                retornoOperaca = "";
                break;
...
//        /*
//         * Está verificação(abaixo) tem como objetivo capturar a "Chave de Consulta" retornado
//         na operação EnviarTesteVendas
//         * O valor é armazenado em uma variavel global e quando o usuario abre a tela para
//         cancelar venda, o campo (Chave de Cancelamento) já fica preenchido
//         */
//        if (operacao.equals("EnviarTesteVendas")) {
//            GlobalValues.ultimaChaveVenda = retornoSat.getChaveConsulta();
////             = GlobalValues.valorCfe;
//        }
//            //* Está função [OperacaoSat.formataRetornoSat] recebe como parâmetro a operação
//            realizada e um objeto do tipo RetornoSat
//        //* Retorna uma String com os valores obtidos do retorno da Operação já formatados e
//        prontos para serem exibidos na tela
