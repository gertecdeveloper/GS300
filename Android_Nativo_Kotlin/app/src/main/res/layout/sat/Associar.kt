package com.example.gs300_kotlin.sat
...
import com.example.gs300_kotlin.GlobalValues
import com.example.gs300_kotlin.Util.CommonCode
import java.util.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_associar.setOnClickListener {
            if (txtCodAtivacao.text.toString().length >= 8) {
                if (txtAssinatura.text.toString().length != 0) {
